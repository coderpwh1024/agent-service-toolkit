...
class VoiceManager:
    ...
    def from_env(cls) -> Optional["VoiceManager"]:
        ...
        Uses Alibaba Cloud Bailian for speech-to-text and text-to-speech.
        A configured DASHSCOPE_API_KEY enables both features automatically;
        VOICE_STT_PROVIDER and VOICE_TTS_PROVIDER can override either feature.
